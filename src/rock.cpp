...
void rock::init()
{
    ...
    myobject.ObsticleRect = { x, y, 140, 80 };
    myobject.ObsticleHitbox = { myobject.ObsticleRect.x + 25, myobject.ObsticleRect.y + 58, 98, 20 }; // center trunk

    myobject.Shadow = {
        x + 25, // center minus half shadow width
        y + 60,     // near bottom of the image
        98,               // shadow width
        30                 // shadow height
    };
}
...
void rock::spawnNear(float player_x, float player_y) {
